        ...
        <div className="relative">
            <div className="flex flex-row items-center gap-3">
                ...
                <div
                    ...
                    flex flex-row items-center gap-3 rounded-full cursor-pointer hover:shadow-sm transition"
                >
                    <AiOutlineMenu />
            ...
            {isOpen && (
                <div
                    className="absolute rounded-xl shadow-md w-[20vw] md:3-3/4 bg-white
